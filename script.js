require(["esri/config", 
         ...
         "esri/request",
         "esri/widgets/Legend"], 
    (esriConfig, Map, MapView, ImageryLayer, FeatureLayer, GeoJSONLayer, Query, esriRequest, Legend, turf) => {
      require(["@turf/turf"], function(turf) {
        const map = new Map({
        ...
        const HUC4_1090 = getWS()

        const clippedSentinel2 = turf.clip(WBD_HUC4, HUC4_1090)
        //getWS();
